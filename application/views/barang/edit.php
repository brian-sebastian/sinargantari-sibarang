        ...
        <div class="card-body">
            <div class="col-12 mb-4">
                <form action="<?= base_url('barang/edit') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php if ($barang["gambar"]) : ?>
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <img src="<?= base_url('assets/file_barang/') . $barang['gambar'] ?>" alt="<?= base_url('assets/file_barang/') . $barang['gambar'] ?>" class="img-fluid d-block img-thumbnail" width="150">
                            </div>
                        </div>
                    <?php endif ?>
                    <div class="row">
                    ...
                    <a href="<?= base_url('barang/index') ?>" class="btn btn-secondary btn-sm">Cancel</a>
                </form>
