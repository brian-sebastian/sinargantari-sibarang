    ...
    <script>
        $(function() {
            initializeTable("server-side", {
                ajax: {
                    url: "<?= site_url('barang_cacat/lp_transaksi_cacat/ajax') ?>",
                    type: "post",
                    data: function(data) {
                ...
                drawCallback: function(settings) {
                    ...
                    $.post("<?= site_url('barang_cacat/lp_transaksi_cacat/ajax/total') ?>", {
            ...
            $("#export_excel").on("click", function() {
                ...
                window.location = "<?= site_url("barang_cacat/lp_transaksi_cacat/export/excel") ?>?field=" + encodedData;
