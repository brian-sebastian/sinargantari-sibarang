        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <h4>Pilih Rentang Tanggal Laporan Penjualan</h4>
                            <br>
    ...
    <script>
        $(function() {
            ...
            initializeTable("server-side", {
                ajax: {
                    url: "<?= site_url('laporan/penjualan/ajax') ?>",
                    type: "post",
                    data: function(data) {
                ...
                drawCallback: function(setting) {
                    ...
                    $.post("<?= site_url('laporan/penjualan/total') ?>", {
        ...
        $("#btn_excel").on("click", function() {
            ...
            window.location = "<?= site_url('laporan/penjualan/excel') ?>?field=" + encodeData;
        })
    </script>