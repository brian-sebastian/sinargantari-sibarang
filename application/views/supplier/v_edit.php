    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('toko/supplier/edit') ?>" method="post">

                        <input type="hidden" name="id_supplier" value="<?= base64_encode($supplier['id_supplier']) ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="nama_supplier" id="nama_supplier" value="<?= $supplier['nama_supplier'] ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" id="no_telpon_supplier" type="text" onkeypress="return isNumber(event);" name="no_telpon_supplier" value="<?= $supplier['no_telpon_supplier'] ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="alamat_supplier" id="alamat_supplier" rows="10"><?= $supplier['alamat_supplier'] ?></textarea>
